...
class ReviewAcceptanceTest extends AcceptanceTest {
    ...
    @Nested
    class getSortingReviews_로그인_사용자_성공_테스트 {
    ...
    @Nested
    class getSortingReviews_로그인_사용자_실패_테스트 {
    ...
    @Nested
    class getSortingReviews_비로그인_사용자_성공_테스트 {

        @Nested
        class 사용자가_좋아요_기준_내림차순으로_리뷰_목록_조회 {
            ...
            void 좋아요_수가_서로_다르면_좋아요_기준_내림차순으로_정렬할_수_있다() {
                ...
                // when
                final var 응답 = 정렬된_리뷰_목록_조회_요청(상품, 첫_목록을_가져옴, 좋아요수_내림차순, FIRST_PAGE);
        ...
        @Nested
        class 사용자가_평점_기준_오름차순으로_리뷰_목록을_조회 {
            ...
            void 평점이_서로_다르면_평점_기준_오름차순으로_정렬할_수_있다() {
                ...
                // when
                final var 응답 = 정렬된_리뷰_목록_조회_요청(상품, 첫_목록을_가져옴, 평점_오름차순, FIRST_PAGE);
        ...
        @Nested
        class 사용자가_평점_기준_내림차순으로_리뷰_목록_조회 {
            ...
            void 평점이_서로_다르면_평점_기준_내림차순으로_정렬할_수_있다() {
                ...
                // when
                final var 응답 = 정렬된_리뷰_목록_조회_요청(상품, 첫_목록을_가져옴, 평점_내림차순, FIRST_PAGE);
        ...
        class 사용자가_최신순으로_리뷰_목록을_조회 {
            ...
            void 등록_시간이_서로_다르면_최신순으로_정렬할_수_있다() {
                ...
                // when
                final var 응답 = 정렬된_리뷰_목록_조회_요청(상품, 첫_목록을_가져옴, 최신순, FIRST_PAGE);
    ...
    @Nested
    class getSortingReviews_비로그인_사용자_실패_테스트 {

        @Test
        void 비로그인_사용자가_존재하지_않는_상품의_리뷰_목록을_조회시_예외가_발생한다() {
            // given && when
            final var 응답 = 정렬된_리뷰_목록_조회_요청(존재하지_않는_상품, 첫_목록을_가져옴, 좋아요수_내림차순, FIRST_PAGE);
