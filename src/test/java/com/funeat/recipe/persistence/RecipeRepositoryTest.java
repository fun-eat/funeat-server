...
class RecipeRepositoryTest extends RepositoryTest {
    ...
    @Nested
    class findAllByProductNameContainingFirst_성공_테스트 {
        ...
        void 상품명에_검색어가_포함된_상품이_있는_레시피들을_조회한다() {
            ...
            // when
            final var actual = recipeRepository.findAllByProductNameContainingFirst("망고", PageRequest.of(0, 2));
    ...
    class findAllByProductNameContaining_성공_테스트 {
        ...
        void 상품명에_검색어가_포함된_상품이_있는_레시피들을_조회한다() {
            ...
            final var recipe1 = 레시피_생성(member);
            final var recipe2 = 레시피_생성(member);
            final var recipe3 = 레시피_생성(member);
            복수_레시피_저장(recipe1, recipe2, recipe3);

            final var productRecipe1 = 레시피_안에_들어가는_상품_생성(product1, recipe1);
            final var productRecipe2 = 레시피_안에_들어가는_상품_생성(product2, recipe1);
            final var productRecipe3 = 레시피_안에_들어가는_상품_생성(product3, recipe2);
            final var productRecipe4 = 레시피_안에_들어가는_상품_생성(product2, recipe3);
            final var productRecipe5 = 레시피_안에_들어가는_상품_생성(product3, recipe3);
            복수_레시피_상품_저장(productRecipe1, productRecipe2, productRecipe3, productRecipe4, productRecipe5);
            ...
            // when
            final var actual = recipeRepository.findAllByProductNameContaining("망고",3L, PageRequest.of(0, 10));
